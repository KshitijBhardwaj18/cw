...
export type UpcomingComplianceStatusFilter =
	| "COMPLETE"
	| "IN_PROGRESS"
	| "MISSING";

export class QueryUpcomingComplianceDto {
	...
	@ApiPropertyOptional({ enum: ["COMPLETE", "IN_PROGRESS", "MISSING"] })
	@IsOptional()
	@IsIn(["COMPLETE", "IN_PROGRESS", "MISSING"])
	complianceStatus?: UpcomingComplianceStatusFilter;
